...
| 规则 | 优先级 | 说明 |
|------|-------|------|
| [05-Skills加载工作流](rules/05-Skills加载工作流.md) | ★★★ | **强制** - 开发任务必须按工作流加载相关 skills |
| [01-Java开发规范](rules/01-Java开发规范.md) | ★★★ | Java 代码规范 |
| [02-API设计规范](rules/02-API设计规范.md) | ★★★ | API 设计标准 |
| [03-Git工作流](rules/03-Git工作流.md) | ★★★ | Git 提交和 PR 规范 |
| [04-性能优化](rules/04-性能优化.md) | ★★ | 性能优化指南 |

> **重点**：规则 `05-Skills加载工作流` 决定了如何使用项目级 skills。所有开发任务都应该遵循这个工作流！
