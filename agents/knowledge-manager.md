...
### 与 continuous-learning Skill 协作

1. **知识收集阶段**: 调用 continuous-learning skill 获取学习机制
2. **模式提取阶段**: 使用 skill 中定义的提取流程
3. **知识存储阶段**: 遵循 skill 中定义的目录结构
4. **知识应用阶段**: 根据 skill 定义的应用方法执行
